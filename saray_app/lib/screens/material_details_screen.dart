                        ...
                        Padding(
                          ...
                          child: new Row(
                            children: <Widget>[
                              new Flexible(
                                child: new TextField(
                                  decoration: kInputBoxDecorationQty.copyWith(
...
//      desc: msg,
                        ...
                        if (_n > 0) {
                          ...
                          addToCart(
                              ...
                              user_id: custId,
                              url: '$BASEURL/api/customer_post.php');
                        } else {
                          Alert(
                            context: context,
//      type: AlertType.info,
...
//    Navigator.of(context).pushReplacementNamed(NavigationDashboard.id);
  ...
  Future<String> getCartCount(String id) async {
    ...
    var response = await http
        .get('$BASEURL/api/customer.php?method=cart_order_count&user_id=$id');
